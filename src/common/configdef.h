...
typedef struct st_env_config
{
   ...
   st_env_config()
   {
    ...
    st_env_config(const std::string& db_ip, unsigned int db_port, const std::string& db_user,const std::string& db_pwd, const std::string& db_name, unsigned short svr_port)
   {
       this->db_ip    = db_ip;
